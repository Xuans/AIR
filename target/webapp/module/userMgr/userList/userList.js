define([].concat(window.aweb.transformJsConfig([ "ctn", "ctn.foundationFormCtn", "ctn.divCtn", "ctn.modalCtn", "ctn.foundationRowCtn", "jquery.dataTables", "dataTables.fixedColumns.min", "component.dataTables", "component.foundationForm", "component.foundationForm.foundationInput", "component.foundationForm.foundationRadioGroup", "component.foundationForm.foundationText" ])).concat(window.aweb.transformCssConfig([ "AUI/css/layout.ctn.css", "foundation/css/foundation.css", "jQuery.dataTables/css/jquery.dataTables.css", "jQuery.dataTables/css/fixedColumns.dataTables.css" ])), function() {
    return function() {
        return function() {
